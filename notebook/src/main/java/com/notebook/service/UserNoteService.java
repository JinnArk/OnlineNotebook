...
public interface UserNoteService {
	 ...
	 */
	int getUserNoteNumByCondition(String userID, String noteTagID, String createDate , String state) throws Exception;
	 ...
	 * @remarks	获取用户事件，根据条件(id)
	 */
	UserNote getNoteByCondition(String noteID) throws Exception;
}
