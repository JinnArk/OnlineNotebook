		...
		<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right dev-page-sidebar mCustomScrollbar _mCS_1 mCS-autoHide mCS_no_scrollbar" id="cbp-spmenu-s1">
			<div class="scrollbar scrollbar1">
				...
				<ul class="nav" id="side-menu">
					<li>
						<a href="/admin/index"><i class="fa fa-home nav_icon"></i>控制台</a>
					</li>
					<li>
						<a href="javascript:;">
						...
						<ul class="nav nav-second-level collapse">
							...
							<li>
								<a href="/admin/systemMail">系统邮箱</a>
							</li>
						</ul>
						<!-- /nav-second-level -->
					</li>
					...
					<li>
						<a href="/admin/notices"><i class="fa fa-th-large nav_icon"></i>
							公告管理
						</a>
					</li>
					...
					<li>
						<a href="javascript:;"><i class="fa fa-envelope nav_icon"></i>
							站内信<span class="fa arrow"></span>
						</a>
						...
						<ul class="nav nav-second-level collapse">
							...
							<li>
								<a href="/commons/letterNew">查找/新建站内信</a>
							</li>
						</ul>
						<!-- //nav-second-level -->
					</li>
